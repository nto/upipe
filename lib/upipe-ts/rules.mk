...
libupipe_ts-src = \
    ...
    upipe_ts_scte_common.c \
    upipe_ts_scte_common.h \
...
configs += libgcrypt libtasn1
libgcrypt-libs = libgcrypt
libtasn1-libs = libtasn1

have_upipe_ts_emmd = $(and $(have_libgcrypt),$(have_libtasn1))

libupipe_ts-includes += \
    $(if $(have_upipe_ts_emmd),upipe_ts_emm_decoder.h)

libupipe_ts-src += \
    $(if $(have_upipe_ts_emmd),rsa_asn1.c rsa_asn1.h upipe_ts_emm_decoder.c)

libupipe_ts-libs = libupipe libupipe_modules bitstream
libupipe_ts-opt-libs = libiconv $(if $(have_upipe_ts_emmd),libgcrypt libtasn1)
